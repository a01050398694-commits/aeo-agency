...
CLI로도 가능:
```bash
gh secret set GEMINI_API_KEY --body "AIzaSyCIqh4_-zD6a-Re2CqrfXIK1p3RR-ISadc"
gh secret set SUPABASE_URL --body "https://qrcaacrevijtwcibzrep.supabase.co"
gh secret set SUPABASE_SERVICE_ROLE_KEY --body "<대시보드에서 복사>"
```
